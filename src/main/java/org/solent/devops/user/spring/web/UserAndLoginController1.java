...
import org.solent.devops.user.dao.impl.UserRepository;
import org.solent.devops.user.model.dto.Address;
import org.solent.devops.user.model.dto.User;
import org.solent.devops.user.model.dto.UserRole;
...
@Controller
@RequestMapping("/")
public class UserAndLoginController1 {

    final static Logger LOG = LogManager.getLogger(UserAndLoginController1.class);
